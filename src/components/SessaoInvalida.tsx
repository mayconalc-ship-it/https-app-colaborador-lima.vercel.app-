...
/**
 * Aparece quando o login é válido mas o cadastro do colaborador não existe
 * mais (conta removida, por exemplo). Sem isso a pessoa via a tela inicial
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-500">
          Seu cadastro não foi encontrado. Entre novamente — se o problema
          continuar, procure seu gestor.
        </p>
        <button
          onClick={sair}
